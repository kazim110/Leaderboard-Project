...
**Leaderboard** is a website that allow users to create a list of persons name and their score using API.
...
```sh
  git clone https://github.com/kazim110/Leaderboard-Project.git
```
...
- **What is this project?**
  ...
  - It's a  project of micoverse curriculum entitled Leaderboard.
...
This project is [MIT](https://github.com/kazim110/Leaderboard-Project/blob/develop/LICENSE) licensed.
